...
public class Tablice {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Deklaracja tablicy poprzez konstruktor  z określeniem ilości elementów w tym przykładzie n=4
         */
        int n = 4;
...
/**
 * Zadanie 1
 * Przykład zadania na wykorzystanie refenecji tablicy dla zmian jej parametrów
 */
class Zadanie1 {
    public static void main(String[] args) {
